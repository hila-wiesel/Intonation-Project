...
if __name__ == '__main__':
    ...
    original_audio, sampling_rate = librosa.load(str(path_original_wav))  # change name inside while loop !!!!!!!
    original_spectrogram = wav_to_mel_spectrogram(original_audio)
    ###########################
    ...
    while True:
        try:
            ...
            print("\ngenerated spectogram:", generated_spec)
