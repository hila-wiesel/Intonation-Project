...
class Toolbox:
    ...
    def setup_events(self):
        ...
        self.ui.word3.clicked.connect(func(2))
        self.ui.word4.clicked.connect(func(3))
        self.ui.word5.clicked.connect(func(4))
        self.ui.word6.clicked.connect(func(5))
        self.ui.word7.clicked.connect(func(6))
